<template>
  <div class="row dashboard-info-widgets">
    ...
    <div class="col-md-6 col-xl-3">
      <batu-widget class="info-widget brand-danger">
        <div class="info-widget-inner">
    ...
    <div class="col-md-6 col-xl-3">
      <batu-widget class="info-widget brand-info">
        <div class="info-widget-inner">
          <div class="stats">
            <div class="stats-number">
...
<script>
  import ProgressBar from '../../components/batu-components/batu-progress-bar/BatuProgressBar'
